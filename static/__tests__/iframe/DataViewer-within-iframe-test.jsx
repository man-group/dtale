...
describe("DataViewer within iframe tests", () => {
  ...
  it("DataViewer: column menu rendering...", async () => {
    ...
    expect(
      ...
      _.concat(
        ["Open In New Tab", "Convert To XArray", "Describe", "Custom Filter", "show_hide", "Build Column"],
        ["Clean Column", "Merge & Stack", "Summarize Data", "Duplicates", "Missing Analysis", "Correlation Analysis"],
        ...
        ["Code Export", "Export", "Load Data", "Refresh Widths", "About", "Theme", "Reload Data", "Pin menu"],
        ["Language", "Shutdown"]
      )
    );
