# ![D-Tale](docs/images/Title.png "D-Tale")
...
![Python Terminal](docs/images/Python_Terminal.png "Python_Terminal")
...
![Chrome #1](docs/images/Browser1.png "Chrome #1")

The information in the upper right-hand corner is similar to saslook  ![Info](docs/images/Info_cell.png "Info")
...
![Menu](docs/images/Info_menu_small.png "Menu")
...
![Column Select](docs/images/Col_select.png "Column Select")

#### Menu functions w/ no columns selected
#### ![Menu](docs/images/Info_menu.png "Menu")
- **Filter**: apply a simple pandas `query` to your data (link to pandas documentation included in popup)

|Editing|Result|
|--------|:------:|
|![Filter Apply](docs/images/Filter_apply.png "Filter Apply")|![Filter Applied](docs/images/Post_filter.png "Filter Applied")|
...
|-----|:-------------:|
|![Coverage Daily](docs/images/Coverage_daily.png "Coverage Daily")|![Coverage Daily Regions](docs/images/Coverage_daily_regions.png "Coverage Daily Regions")|
...
|------|----------|-------|
|![Correlations](docs/images/Correlations.png "Correlations")|![Timeseries](docs/images/Correlations_ts.png "Timeseries")|![Scatter](docs/images/Correlations_scatter.png "Scatter")|
...
#### ![Menu Single-Column](docs/images/Menu_one_col.png "Menu Single-Column")
...
- **Formats**: apply simple formats to numeric values in your grid
  ...
  |Editing|Result|
  |--------|:------:|
  |![Formatting Apply](docs/images/Formatting_apply.png "Formatting Apply")|![Formatting Applied](docs/images/Post_formatting.png "Formatting Applied")|
...
![Histogram](docs/images/Histogram.png "Histogram")
...
>>> dtale.show(df)
```
Then view your D-Tale instance in your browser using `http://[hostname of docker process]:9201`
...
>>> dtale.show(df)
```
Then view your D-Tale instance in your browser using `http://[hostname of docker process]:9202`
