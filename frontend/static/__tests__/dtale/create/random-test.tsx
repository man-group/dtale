...
describe('CreateRandom', () => {
  ...
  it('DataViewer: build random date column', async () => {
    ...
    await act(async () => {
      await fireEvent.click(result.getElementsByClassName('bp6-popover-target')[0]);
    });
    await act(async () => {
      await fireEvent.change(result.getElementsByClassName('bp6-input')[0], { target: { value: '20000101' } });
    });
    await act(async () => {
      await fireEvent.change(result.getElementsByClassName('bp6-input')[1], { target: { value: '20000102' } });
    });
    await act(async () => {
